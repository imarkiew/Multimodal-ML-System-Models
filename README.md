...
The data set has been divided into training (75 %) and validation (25 %) set. For training set data augmentation was used.
...
**ROC curves for the validation set**

<p align="center">
<img src="./readme_content/confusionMatrixVal.png" width="85%" height="85%">
</p>

**Confusion matrix for the validation set**

2. Breast cancer - 2 classes, record classification using several models from scikit & xgboost with 10 CV \
